...
const merchItems = [
  { id: '1', name: 'Pleasing Serum', price: 45, image: require('../assets/pleasing.jpg') },
  { id: '2', name: 'Harry Poster', price: 30, image: require('../assets/poster3.jpg') },
  { id: '3', name: 'Pleasing Perfume', price: 25, image: require('../assets/pleasing1.jpg') },
  { id: '4', name: 'Harry vinyl', price: 20, image: require('../assets/vinyl.jpg') },
];

const socialLinks = [
  { id: '1', name: 'Instagram', url: 'https://www.instagram.com/harrystyles/', icon: 'instagram' },
  { id: '2', name: 'YouTube', url: 'https://www.youtube.com/c/HarryStyles', icon: 'youtube' },
  { id: '3', name: 'Twitter', url: 'https://twitter.com/Harry_Styles', icon: 'twitter' },
  { id: '4', name: 'Facebook', url: 'https://www.facebook.com/harrystyles', icon: 'facebook' },
];
...
/>
    ...
    if (activeTab === 'events') {
      return (
        <FlatList
          data={[
            { id: '1', date: 'March 25, 2025', place: 'Madison Square Garden, New York, USA', time: '8:00 PM' },
            { id: '2', date: 'April 15, 2025', place: 'The O2 Arena, London, UK', time: '4:00 PM' },
            { id: '3', date: 'June 5, 2025', place: 'Accor Arena, Paris, France', time: '7:30 PM' },
            { id: '4', date: 'October 10, 2025', place: 'Sydney Opera House, Sydney, Australia', time: '6:45 PM' },
          ]}
          keyExtractor={(item) => item.id}
          renderItem={({ item }) => (
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <ImageBackground source={require('../assets/harryf.jpg')} style={styles.artistImage}>
          <View style={styles.overlay}>
            <Text style={styles.artistName}>Harry styles</Text>
          </View>
        </ImageBackground>
      </View>
